...
// The CuriosityFunc type is an adapter to allow the use of ordinary
// function as Curiosity mutator.
type CuriosityFunc func(context.Context, *ent.CuriosityMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f CuriosityFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.CuriosityMutation); ok {
		return f(ctx, mv)
	}
