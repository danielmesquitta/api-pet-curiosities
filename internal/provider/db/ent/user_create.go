...
func (uc *UserCreate) SetTier(u user.Tier) *UserCreate {
	uc.mutation.SetTier(u)
	return uc
}

// SetNillableTier sets the "tier" field if the given value is not nil.
func (uc *UserCreate) SetNillableTier(u *user.Tier) *UserCreate {
	if u != nil {
		uc.SetTier(*u)
	}
	return uc
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.SubscriptionExpiresAt(); ok {
