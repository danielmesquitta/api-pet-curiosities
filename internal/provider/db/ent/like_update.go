...
func (lu *LikeUpdate) SetCuriosityID(id uuid.UUID) *LikeUpdate {
	lu.mutation.SetCuriosityID(id)
	return lu
}

// SetNillableCuriosityID sets the "curiosity" edge to the Curiosity entity by ID if the given value is not nil.
func (lu *LikeUpdate) SetNillableCuriosityID(id *uuid.UUID) *LikeUpdate {
	if id != nil {
		lu = lu.SetCuriosityID(*id)
	}
	return lu
}

// SetCuriosity sets the "curiosity" edge to the Curiosity entity.
func (lu *LikeUpdate) SetCuriosity(c *Curiosity) *LikeUpdate {
	return lu.SetCuriosityID(c.ID)
}
...
func (lu *LikeUpdate) ClearCuriosity() *LikeUpdate {
	lu.mutation.ClearCuriosity()
	return lu
}
...
func (lu *LikeUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if lu.mutation.CuriosityCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
			Table:   like.CuriosityTable,
			Columns: []string{like.CuriosityColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if nodes := lu.mutation.CuriosityIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
			Table:   like.CuriosityTable,
...
// SetCuriosityID sets the "curiosity" edge to the Curiosity entity by ID.
func (luo *LikeUpdateOne) SetCuriosityID(id uuid.UUID) *LikeUpdateOne {
	luo.mutation.SetCuriosityID(id)
	return luo
}

// SetNillableCuriosityID sets the "curiosity" edge to the Curiosity entity by ID if the given value is not nil.
func (luo *LikeUpdateOne) SetNillableCuriosityID(id *uuid.UUID) *LikeUpdateOne {
	if id != nil {
		luo = luo.SetCuriosityID(*id)
	}
	return luo
}

// SetCuriosity sets the "curiosity" edge to the Curiosity entity.
func (luo *LikeUpdateOne) SetCuriosity(c *Curiosity) *LikeUpdateOne {
	return luo.SetCuriosityID(c.ID)
}
...
// ClearCuriosity clears the "curiosity" edge to the Curiosity entity.
func (luo *LikeUpdateOne) ClearCuriosity() *LikeUpdateOne {
	luo.mutation.ClearCuriosity()
	return luo
}
...
func (luo *LikeUpdateOne) sqlSave(ctx context.Context) (_node *Like, err error) {
	...
	if luo.mutation.CuriosityCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
			Table:   like.CuriosityTable,
	...
	if nodes := luo.mutation.CuriosityIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: false,
			Table:   like.CuriosityTable,
